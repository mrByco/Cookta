...
describe("Metrics service", () => {
    ...
    describe("Merge metrics data", () => {
        it('should keep old data if no overriding data', function () {
            let record: MetricsRecord = {_id: new ObjectId("507f191e810c19729de860ea"), data: [[], [5,4]], key_id: "", stat_key: ""}
            let recordToMerge: MetricsRecord = {_id: new ObjectId("507f191e810c19729de860eb"), data: [], key_id: "", stat_key: ""}
