import {IShoppingList, IShoppingIngredient} from 'cookta-shared/src/models/shopping-list/shopping-list.interface';
...
export interface IShoppingListService {
    ...
    GetReqList(familyId: string, from: string, to: string): Promise<IShoppingIngredient[]>;
    ...
    SetCompleteQuantityAndTargetPrice(familyId: string, ingredient: IIngredient, targetSection: string, price?: number): Promise<void>;
}
