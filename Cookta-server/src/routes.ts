...
export function RegisterRoutes(app: express.Express) {
    ...
    app.get('/food/own',
        ...
        function(request: any, response: any, next: any) {
            ...
            const promise = controller.GetOwnFoods.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/food/family',
        ...
        function(request: any, response: any, next: any) {
            ...
            const promise = controller.GetFamilyFoods.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/food/subscription',
        ...
        function(request: any, response: any, next: any) {
            ...
            const promise = controller.GetSubscriptionFoods.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/food/:id',
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/ingredientType/check/unit/:unitId',
        authenticateMiddleware([{ "Bearer": ["advanced-ingredients"] }]),
        function(request: any, response: any, next: any) {
            const args = {
                unitId: { "in": "path", "name": "unitId", "required": true, "dataType": "string" },
            };
            ...
            const promise = controller.GetUnitRefs.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.put('/ingredientType/delete/unit',
        ...
        function(request: any, response: any, next: any) {
            ...
            const promise = controller.DeleteCustomUnit.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/unit',
    ...
    app.get('/user/:name',
        function(request: any, response: any, next: any) {
            ...
            const promise = controller.GetNameAlreadyUsed.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    app.get('/ShoppingList/:nextShopping',
        ...
        function(request: any, response: any, next: any) {
            const args = {
                request: { "in": "request", "name": "request", "required": true, "dataType": "object" },
                nextShopping: { "in": "path", "name": "nextShopping", "required": true, "dataType": "string" },
            };
            ...
            const promise = controller.GetShoppingList.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
